 ...
 */
final class Version20210403140136 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gangs ADD reputation INT NOT NULL, ADD wealth INT NOT NULL, ADD alliance VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
