 ...
 */
final class Version20210401082957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gangers DROP credits, DROP cool, DROP willpower, DROP intelligence');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gangers ADD credits INT NOT NULL, ADD cool INT NOT NULL, ADD willpower INT NOT NULL, ADD intelligence INT NOT NULL');
