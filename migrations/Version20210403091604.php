 ...
 */
final class Version20210403091604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       //  $this->addSql('ALTER TABLE territories_gangs ADD CONSTRAINT FK_E6C8E06033B9A304 FOREIGN KEY (territories_id) REFERENCES territories (id) ON DELETE CASCADE');
        ...
        //$this->addSql('ALTER TABLE gangs DROP FOREIGN KEY FK_CF53F7EA6BB74516');
        //$this->addSql('DROP INDEX IDX_CF53F7EA6BB74516 ON gangs');
        //$this->addSql('ALTER TABLE gangs ADD reputation INT NOT NULL, ADD wealth INT NOT NULL, ADD alliance VARCHAR(255) NOT NULL');
