 ...
 */
final class Version20210331180848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE houses ADD reputation INT NOT NULL, ADD wealth INT NOT NULL, ADD alliance VARCHAR(255) NOT NULL');
