...
final class Version20210401180414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gangers DROP cool, DROP willpower, DROP intelligence');
        ...
        $this->addSql('ALTER TABLE my_gangers DROP cool, DROP willpower, DROP intelligence');
