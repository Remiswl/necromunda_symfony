 ...
 */
final class Version20210421193339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE injuries ADD min_d66 INT NOT NULL, ADD max_d66 INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE injuries DROP min_d66, DROP max_d66');
