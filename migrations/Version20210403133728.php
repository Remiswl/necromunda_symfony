 ...
 */
final class Version20210403133728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE gangs ADD image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gangs DROP image');
