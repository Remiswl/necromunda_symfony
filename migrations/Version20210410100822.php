 ...
 */
final class Version20210410100822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE injuries ADD d66 INT NOT NULL, DROP d6tens, DROP d6units');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE injuries ADD d6units INT NOT NULL, CHANGE d66 d6tens INT NOT NULL');
